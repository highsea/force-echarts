					...
					strArr = {
						...
						onclick 	: function(params){
										...
										if (top.location == self.location){
											...
											window.open('public/user.php?user='+params.target.style.text,'newwindow','height=800,width=960,top=0,left=0,toolbar=yes,menubar=yes,scrollbars=yes,resizable=yes,location=yes,status=yes');
										}
